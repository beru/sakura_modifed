/*
	...
	freely, subject to the following restrictions:
		...
		3. This notice may not be removed or altered from any source
		   distribution.
*/
// CtagsPlugin.cpp : DLL アプリケーション用にエクスポートされる関数を定義します。
//
...
{
	PLUGIN_INITIALIZE;
	thePluginService.OnPluginCtagsOptionDialog(obj);
}
...
{
	PLUGIN_INITIALIZE;
	thePluginService.OnPluginCtagsJumpDialog(obj);
}
...
{
	PLUGIN_INITIALIZE;
	thePluginService.OnPluginCtagsJump(obj);
}
