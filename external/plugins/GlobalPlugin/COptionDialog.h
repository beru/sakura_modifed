...
{
public:
	COptionDialog(CGlobalOption* lpGlobalOption, std::list<CGlobalInfo*>* lpGlobalInfoList);
...
private:
	...
	int InsertItem(HWND hList, int nIndex, CGlobalInfo* info);
	void GetItem(HWND hList, int nIndex, CGlobalInfo* info);
	void ControlButton();
