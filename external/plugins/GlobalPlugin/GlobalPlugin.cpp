/*
	...
	freely, subject to the following restrictions:
		...
		3. This notice may not be removed or altered from any source
		   distribution.
*/
// GlobalPlugin.cpp : DLL アプリケーション用にエクスポートされる関数を定義します。
//
...
{
	PLUGIN_INITIALIZE;
	thePluginService.OnPluginGlobalOptionDialog(obj);
}
...
{
	PLUGIN_INITIALIZE;
	thePluginService.OnPluginGlobalJumpDialog(obj);
}
...
{
	PLUGIN_INITIALIZE;
	thePluginService.OnPluginGlobalJump(obj);
}
