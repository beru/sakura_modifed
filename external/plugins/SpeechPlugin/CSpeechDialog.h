...
#ifndef _PLUGIN_SPEECHDIALOG_H__
#define _PLUGIN_SPEECHDIALOG_H__
...
///////////////////////////////////////////////////////////////////////////////
class CSpeechDialog : public CPluginDialog
{
public:
	CSpeechDialog();
...
private:
	...
	WideString	m_strVoice;
	int			m_nVolume;
	int			m_nRate;
};

#endif	// _PLUGIN_SPEECHDIALOG_H__
