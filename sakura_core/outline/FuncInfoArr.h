...
public:
	...
	void AppendData(size_t, size_t, const TCHAR*, int, size_t nDepth = 0);		// 配列の最後にデータを追加する
	void AppendData(size_t, size_t, const NOT_TCHAR*, int, size_t nDepth = 0);	// 配列の最後にデータを追加する
