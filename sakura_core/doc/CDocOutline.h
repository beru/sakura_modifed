...
public:
	...
	void	MakeFuncList_python(FuncInfoArr* pcFuncInfoArr);						// Python アウトライン解析 // 2007.02.08 genta
	void	MakeFuncList_Erlang(FuncInfoArr* pcFuncInfoArr);						// Erlang アウトライン解析 // 2009.08.10 genta
