...
public:
	...
	bool IsEditable() const { return !AppMode::getInstance()->IsViewMode() && !(!m_docLocker.IsDocWritable() && GetDllShareData().m_common.file.m_bUneditableIfUnwritable); }	// 編集可能かどうか
