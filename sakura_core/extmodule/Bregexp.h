...
public:
	...
	bool Match(const wchar_t* szTarget, size_t nLen, int nStart = 0);					// 検索を実行する
	int Replace(const wchar_t* szTarget, size_t nLen, int nStart = 0);					// 置換を実行する	// 2007.01.16 ryoji 戻り値を置換個数に変更
