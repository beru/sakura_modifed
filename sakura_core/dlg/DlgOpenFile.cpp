...
//	OFNOTIFY*				pofn;
	...
	case WM_MOVE:
		...
		::GetWindowRect(hwnd, &pShareData->m_common.others.rcOpenDialog);
	...
	case WM_SIZE:
		{
			...
			::GetWindowRect(hwndFrame, &pData->m_pDlgOpenFile->m_mem->m_pShareData->m_common.others.rcOpenDialog);
