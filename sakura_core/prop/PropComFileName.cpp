...
{
	::CheckDlgButtonBool( hwndDlg, IDC_CHECK_SHORTPATH, m_common.fileName.m_bTransformShortPath );
	::SetDlgItemInt( hwndDlg, IDC_EDIT_SHORTMAXWIDTH, m_common.fileName.m_nTransformShortMaxWidth, FALSE );
...
int PropFileName::GetData(HWND hwndDlg)
{
	...
	m_common.fileName.m_bTransformShortPath = ::IsDlgButtonCheckedBool( hwndDlg, IDC_CHECK_SHORTPATH );
	m_common.fileName.m_nTransformShortMaxWidth = ::GetDlgItemInt( hwndDlg, IDC_EDIT_SHORTMAXWIDTH, NULL, FALSE );
